...
cartpole_sampled_efficientzero_config = dict(
    exp_name=
    f'data_sez_ctree_cartpole_eval/cartpole_MuZero_with_random_adv_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_bs_{batch_size}_seed_{seed}',
    env=dict(
        env_id='CartPole-v1',
        continuous=False,
...
model_path_list = [        './data_sez_ctree_cartpole/cartpole_RobustZero_with_random_cl_ns50_upc100_rr0.0_bs_256_seed_0_240723_005802/ckpt_agent_learner/ckpt_best_agent_evaluator_with_random.pth.tar',
'./data_sez_ctree_cartpole/cartpole_RobustZero_with_random_cl_ns50_upc100_rr0.0_bs_256_seed_0_240723_011442/ckpt_agent_learner/ckpt_best_agent_evaluator_with_random.pth.tar',
'./data_sez_ctree_cartpole/cartpole_RobustZero_with_random_cl_ns50_upc100_rr0.0_bs_256_seed_0_240723_011913/ckpt_agent_learner/ckpt_best_agent_evaluator_with_random.pth.tar',
    ]
