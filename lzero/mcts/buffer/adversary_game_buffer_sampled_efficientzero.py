...
@BUFFER_REGISTRY.register('adversary_game_buffer_sampled_efficientzero')
class AdversarySampledEfficientZeroGameBuffer(EfficientZeroGameBuffer):
    """
    Overview:
    ...
    def sample(self, batch_size: int, policy: Any) -> List[Any]:
        ...
        if self._cfg.reanalyze_ratio > 0:
            ...
            # current_batch = [obs_list, true_obs_list, action_list, root_sampled_actions_list, mask_list, batch_index_list, weights_list, make_time_list]
    ...
    def _make_batch(self, batch_size: int, reanalyze_ratio: float) -> Tuple[Any]:
        ...
        obs_list, true_obs_list, action_list, mask_list = [], [], [], []
        ...
        for i in range(batch_size):
            ...
            true_obs_list.append(game_lst[i]
                                 .get_unroll_true_obs( pos_in_game_segment_list[i],
                                                       num_unroll_steps=self._cfg.num_unroll_steps, padding=True))
        ...
        true_obs_list = prepare_observation(true_obs_list, self._cfg.model.model_type)
        # ==============================================================
        # sampled related core code
        # ==============================================================
        # formalize the inputs of a batch
        current_batch = [
            obs_list, true_obs_list, action_list, root_sampled_actions_list, mask_list, batch_index_list, weights_list, make_time_list
        ]
    ...
    def update_priority(self, train_data: List[np.ndarray], batch_priorities: Any) -> None:
        ...
        batch_index_list = train_data[0][5]
        metas = {'make_time': train_data[0][7], 'batch_priorities': batch_priorities}
